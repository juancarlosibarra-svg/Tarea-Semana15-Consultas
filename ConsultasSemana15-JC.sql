...
-- COMPROBACION 01
select * from propietarios where telefono='+503-7890-1234';
...
VALUES (6, 'Apartamento Vista Hermosa', 'apartamento', 'Av. Magnolias #456', 'San Salvador', 'El Sal6vador', 85.00, 4, 2, 2);
...
-- COMPROBACION 03
select * from huespedes where email='carlos.g@email.com';


-- 04. INSERT - Insertar pago
INSERT INTO pagos (id_reserva, monto, metodo_pago)
VALUES (13, 425.00, 'tarjeta');

-- COMPROBACION 04
select * from pagos where id_reserva=13;
...
-- COMPROBACION 05
select * from alojamientos where activo=true;
...
-- COMPROBACION 06
select * from huespedes where nacionalidad='Estados Unidos';
...
-COMPROBACIÓN 8
SELECT id_alojamiento, precio_noche 
FROM alojamientos 
WHERE id_alojamiento = 1;
